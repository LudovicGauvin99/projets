...
<h2>Capteurs de vibration</h2>	
<br>
<table class="table table-bordered">
<tr><th>vibration </th><th>date </th></tr>
<?php
...
if ($connexion) {
 ...
 $query = "SELECT mes_valeur, mes_date, mes_typId, typ_unite FROM mesure INNER JOIN typemesure ON (mes_typId = typ_id) WHERE typ_nom ='vibration'";
